...
describe('WebsiteSettings Key-Value Integration Tests', () => {
  ...
  describe('Website Icon Operations', () => {
    ...
    it('should handle complete website icon workflow', async () => {
      ...
      await updateWebsiteIcon.execute('test', icon);
      ...
      // Remove icon
      await updateWebsiteIcon.execute('test', null);
  ...
  describe('Error Handling', () => {
    it('should handle database errors gracefully across all operations', async () => {
      ...
      // All get operations should handle errors
      await expect(getWebsiteName.execute()).rejects.toThrow(
        'Database connection failed'
      );
      await expect(getWebsiteIcon.execute()).rejects.toThrow(
        'Database connection failed'
      );
      // GetThemeColor has fallback to default value, so it should not throw
      ...
      await expect(updateWebsiteIcon.execute('test', icon)).rejects.toThrow(
        'Database connection failed'
      );
