...
describe('MongooseWebsiteSettingsRepository', () => {
  ...
  describe('exists', () => {
    it('should return true when document exists', async () => {
      ...
      const result = await repository.exists('website-name');
    ...
    it('should return false when document does not exist', async () => {
      ...
      const result = await repository.exists('non-existent-key');
    ...
    it('should handle errors during existence check', async () => {
      ...
      await expect(repository.exists('test-key')).rejects.toThrow(
        'Database connection failed'
      );
    });
  });
